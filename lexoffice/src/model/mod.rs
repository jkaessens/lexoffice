# ! [ allow ( missing_docs ) ] # ! [ doc = r" This model was semi-automaticly generated from The official lexoffice" ] # ! [ doc = r" documentation" ] # ! [ doc = r"" ] # ! [ doc = r" See <https://developers.lexoffice.io/docs/> for more information" ]pub mod pages;
pub mod contacts;
